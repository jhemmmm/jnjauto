...
<body style="font-family: Arial, sans-serif; color: #1f2937; line-height: 1.5;">
    <h1 style="font-size: 22px; margin-bottom: 12px;">Appointment Status Updated</h1>

    <p>Hello {{ $appointment->customer_name }},</p>

    <p>Your appointment with {{ $businessName }} is now marked as <strong>{{ $statusLabel }}</strong>.</p>
