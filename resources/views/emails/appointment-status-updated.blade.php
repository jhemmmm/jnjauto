                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td valign="middle" style="color: #ffffff;">
                                        ...
                                        <div style="font-size: 25px; line-height: 1.2; font-weight: 800; margin-top: 4px;">Appointment Status Updated</div>
                                        <div style="font-size: 14px; line-height: 1.5; margin-top: 6px; opacity: 0.9;">Your booking status has changed.</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 30px 28px 8px;">
                            ...
                            <p style="margin: 0; color: #4b5563; font-size: 15px; line-height: 1.7;">
                                Your appointment with <strong>{{ $businessName }}</strong> is now marked as
                                <span style="display: inline-block; margin-left: 4px; padding: 4px 10px; background: #e0f2fe; color: #0f6f99; border-radius: 999px; font-size: 12px; font-weight: 800; text-transform: uppercase;">{{ $statusLabel }}</span>.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 18px 28px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #e5eef5; border-radius: 14px; overflow: hidden;">
                                <tr>
                                    <td colspan="2" style="background: #eff8fc; padding: 14px 18px; color: #0f6f99; font-size: 13px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.04em;">Appointment Details</td>
                                </tr>
                                <tr>
